...
%IFDEF SIZE_320_200
ModeNumber	EQU 410FH
%ENDIF

%IFDEF SIZE_640_400
ModeNumber	EQU 4123H
%ENDIF
...
%IFDEF SIZE_896_672
ModeNumber	EQU 4132H
%ENDIF

%IFDEF SIZE_1024_640
ModeNumber	EQU 416DH
%ENDIF
...
%IFDEF SIZE_1440_900
ModeNumber	EQU 4163H
%ENDIF

%IFDEF SIZE_1600_1200
ModeNumber	EQU 411FH
%ENDIF
...
;175~399	*未使用*
;400~719	64个任务的TSS描述符, 任务门描述符, 代码段描述符和数据段描述符
;			分别是：TSS描述符、任务门描述符、Ring0/3代码段描述符、Ring0/3数据段描述符、Ring0数据段描述符。
;720~2509	*未使用*
GDT:
	;Empty descriptor
	Desc	0, 0, 0
